...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ServiceSample.BindServiceActivity, ServiceSample, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BindServiceActivity.class, __md_methods);
	}


	public BindServiceActivity ()
	{
		super ();
		if (getClass () == BindServiceActivity.class)
			mono.android.TypeManager.Activate ("ServiceSample.BindServiceActivity, ServiceSample, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
